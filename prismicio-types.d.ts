...
interface SettingsDocumentData {
   ...
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.cta_lale
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  cta_lale: prismic.KeyTextField;
...
export interface ExperienceSliceDefaultPrimaryExpItem {
  /**
   * Company Title field in *Experience → Default → Primary → Exp*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.exp[].company_title
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
